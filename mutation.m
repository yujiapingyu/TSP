function [ C ] = mutation( A, w, L, mutation_rate, distance_matric )
% A变异产生子代C
...
C = normalization(circle_modification(mutation_path_table, mutation_row_length, L, distance_matric), L);
